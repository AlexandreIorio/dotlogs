...
## LogService\.LogFatal\(string, string, string, int\) Method

Logs a fatal error message and returns the message\.

```csharp
public string LogFatal(string message, string caller="", string callerFilePath="", int callerLineNumber=0);
```
#### Parameters

<a name='DotLogs.LogService.LogFatal(string,string,string,int).message'></a>

`message` [System\.String](https://learn.microsoft.com/en-us/dotnet/api/system.string 'System\.String')

The message to log\.

<a name='DotLogs.LogService.LogFatal(string,string,string,int).caller'></a>
...
<a name='DotLogs.LogService.LogFatal(string,string,string,int).callerFilePath'></a>
...
<a name='DotLogs.LogService.LogFatal(string,string,string,int).callerLineNumber'></a>
